...
BindDepDest.prototype.onDepartureSelect = function(bindObject){
    ...
    //console.log("1 Departure Location Text: " + this.getADepartureLocText());
    //console.log("1 Destination Location Text: " + this.getADestinationLocText());
	...
	//console.log("Departure Location Text: " + bindObject.getADepartureLocText());
	//console.log("Destination Location Text: " + bindObject.getADestinationLocText());
